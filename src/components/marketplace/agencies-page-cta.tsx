...
export async function AgenciesPageCta() {
  ...
  return (
    <section className="relative overflow-hidden bg-primary py-16 sm:py-20">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_rgba(212,168,83,0.15)_0%,transparent_50%)]" />
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        <Building2 className="mx-auto size-10 text-[var(--tunrent-gold)]" aria-hidden />
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
          <Button
            ...
            asChild
          >
            <Link href="/devenir-partenaire">{t("ctaPartner")}</Link>
          </Button>
          <Button
            size="lg"
            variant="outline"
