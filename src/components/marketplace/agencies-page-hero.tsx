...
export async function AgenciesPageHero() {
  const t = await getTranslations("marketplace.agencies");

  const badges = [
    { icon: ShieldCheck, key: "badge1" as const },
    { icon: MapPin, key: "badge2" as const },
    { icon: Star, key: "badge3" as const },
  ] as const;
  ...
  return (
    <section className="relative overflow-hidden bg-primary">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_rgba(212,168,83,0.14)_0%,transparent_55%)]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm text-white/90 backdrop-blur-sm">
            <Building2 className="size-4 text-[var(--tunrent-gold)]" aria-hidden />
            {t("heroBadge")}
          </div>
